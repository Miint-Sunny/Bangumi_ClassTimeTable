...
const CHANGELOG: LogEntry[] = [
  ...
  },
  {
    d: '2026-09-20',
    x: {
      'zh-Hans': '讨论会补两样:房间码旁边有二维码,点开放大成投屏用的大图,手机扫一下就进房;顶部"📋 共识榜"把大家的票分成 都想看 / 有人想看 / 观望 / 跳过 四层排好,一键复制成文字发群,或导出成 PNG 图片;点榜上任一行跳到那部',
      'zh-Hant': '討論會補兩樣:房間碼旁邊有二維碼,點開放大成投屏用的大圖,手機掃一下就進房;頂部「📋 共識榜」把大家的票分成 都想看 / 有人想看 / 觀望 / 跳過 四層排好,一鍵複製成文字發群,或匯出成 PNG 圖片;點榜上任一行跳到那部',
      ja: '座談会に 2 つ追加:ルームコードの横に QR コード、クリックで投影用に拡大、スマホで読めば入室。上部の「📋 みんなの結論」は票を 全員見たい / 誰か見たい / 保留 / スキップ の 4 層に整理し、テキストとしてコピーするか PNG 画像で保存可能。行をクリックするとその作品へ',
      en: 'Two additions to discussion: a QR code next to the room code (click to enlarge for screen sharing — scan to join), and a "📋 Consensus" board at the top that groups everyone\'s votes into everyone / someone / maybe / skip, copyable as text or exportable as a PNG; click any row to jump to that show',
    },
  },
  {
    d: '2026-09-20',
